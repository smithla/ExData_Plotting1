# Plot2.R - Exporatory Data Analysis - Homework 1
...
plot(df_proper$DateTime,as.numeric(df_proper$Global_active_power),type="l",ylab="Global Active Power (Kilowatts)",xlab="")
dev.off()